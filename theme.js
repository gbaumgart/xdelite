...
define([
    ...
    var load = /** @lends module:delite/theme */ {
        ...
        load: function (path, require, onload) {
            ...
            var commonCss = module.id.replace(/\/.*/, "") + "{{themeRoot}}/themes/{{theme}}/common.css";
            ...
            if (config.variables) {
                ...
                commonCss = utils.replace(commonCss, null, config.variables, _delimiters);
                path = utils.replace(path, null, config.variables, _delimiters);
            }
